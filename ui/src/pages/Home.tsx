...
export default function Home() {
  return (
    <>
      ...
      <section className="max-w-[1200px] mx-auto px-12 py-[120px] grid grid-cols-2 gap-20 items-start" id="about">
        <div>
        ...
        <div className="text-[0.88rem] leading-[1.85] text-[rgba(245,240,232,0.55)] space-y-5">
      ...
      <section className="max-w-[1200px] mx-auto px-12 pb-[120px]" id="services">
